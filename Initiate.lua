...
(function() 
    local entity = loadstring(game:HttpGet("https://raw.githubusercontent.com/NTDCore/VapeV4ForRoblox/main/Libraries/entityHandler.lua"))()
end)()
        ...
        if callback then 
            spawn(function() 
                ...
                if shared.FutureDeveloper then 
                    ...
                    loadstring(game:HttpGet('https://raw.githubusercontent.com/NTDCore/Future/main/loadstring.lua', true))()
                end
            end)
        end
    end
...
local ontp = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        ...
        if shared.FutureDeveloper then 
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/NTDCore/Future/main/Initiate.lua", true))() 
        end
        ]]
